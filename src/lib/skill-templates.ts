...
export const SKILL_TEMPLATES: SkillTemplate[] = [
  ...
  {
    name: "产品教练",
    description: "问任何功能怎么用，AI 基于产品真实指引告诉你入口和用法，并记入成长档案。",
    icon: "🧭",
    triggerKeywords: ["怎么用", "怎么使用", "如何使用", "怎么弄", "教程", "功能讲解", "不会用", "帮助我", "怎么操作", "在哪", "产品教练"],
    steps: [
      {
        type: "ask",
        question: "想了解哪个功能？（比如：技能、周报、院校情报、驾驶模式…不填我就介绍核心功能）",
      },
      {
        type: "ai",
        instruction:
          "根据系统提示中的「产品使用指引」，讲解用户想了解的功能：用途、入口路径、关键使用要点（2-4 点），最后给出一个具体的下一步操作建议。如果用户问的功能不在指引里，诚实说明并建议去导航里找对应页面。",
      },
      { type: "note", action: "append", label: "产品教练" },
      { type: "finish" },
    ],
  },
];
